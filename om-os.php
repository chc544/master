...
<link rel="stylesheet" href="css/om-os.css" type="text/css">
<link rel="stylesheet" href="css/bootstrap.css" type="text/css">
<link rel="stylesheet" href="css/styles.css" type="text/css">
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta2/dist/js/bootstrap.bundle.min.js" integrity="sha384-b5kHyXgcpbZJO/tY9Ul7kGkf1S0CWuKcCD38l8YkeH8z8QjE0GmW1gYU5S9FOnJ0" crossorigin="anonymous"></script>
<title>Lions Nyk F. - Om os</title>

<?php include "includes/menu.php";?>

<section class="om-os">
    <div class="om-os__lokalt">
        <div class="container">
            <div class="om-os__wrapper__left">
                <div class="om-os__title__wrapper">
                    <img src="img/lokaltikon.svg" alt="lokaltikon" style="height:70px; width:50px; margin-right:20px;">
                    <h1>Lokalt - 50% af vores donationer går til lokale formål</h1>
                </div>
                <p>Klubben i Nykøbing Falster er en lille klub med fokus på velgørende arbejde i og omkring Nykøbing F. <br>
    ...
    <div class="om-os__nationalt">
        <div class="container">
            <div class="om-os__wrapper__right">
                <div class="om-os__title__wrapper">
                    <img src="img/nationaltikon.svg" alt="nationaltikon" style="height:70px; width:50px; margin-right:20px;">
                    <h1>Nationalt - 25% af vores donationer går til nationale formål</h1>
                </div>
                ...
                <ul>
                    <li><a href="https://www.lions.dk/det_goer_vi" target="_blank">Lions Kollegiet</a></li>
                    <li><a href="https://www.lions.dk/det_goer_vi" target="_blank">Dansk Blindesamfund</a></li>
                    <li><a href="https://www.lions.dk/det_goer_vi" target="_blank">Lions Quest Danmark</a></li>
                </ul>
                </p>
            </div>
            <img src="img/nationalt.jpeg" alt="nationalt" class="img-fluid">
        </div>
    </div>

    <div class="om-os__internationalt">
        <div class="container">
            <div class="om-os__wrapper__left">
                <div class="om-os__title__wrapper">
                    <img src="img/internationaltikon.svg" alt="internationaltikon" style="height:70px; width:50px; margin-right:20px;">
                    <h1>Internationalt - 25% af vores donationer går til internationale formål</h1>
                </div>
