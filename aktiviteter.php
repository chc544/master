...
<section class="aktiviteter">
    ...
    <div class="container">
        <div class="row">
            <div class="col">
                <div class="aktiviteter__title__wrapper">
                    <img src="img/sour-soup.svg" alt="soup">
                    <h3>Torvesuppe</h3>
                </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col">
                <div class="aktiviteter__title__wrapper">
                    <img src="img/charity.svg" alt="frivillig">
                    <h3>Frivillig, hvem, mig?</h3>
                </div>
